...
- **Extensibility** — MCP servers (stdio + HTTP/SSE), deployment-ready managed Git repositories with review and approval gates, skill system, 15 lifecycle hook events with circuit breaker, destructive command guard
