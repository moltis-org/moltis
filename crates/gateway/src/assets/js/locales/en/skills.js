...
export default {
	...
	installDepConfirm: "Install dependency for {{name}}?\n\n{{preview}}\n\nOnly continue if you trust this skill and its source.",
	installedDep: "Installed dependency for {{name}}",
	installFailed: "Install failed: {{error}}",

	// ── Commit warning ──────────────────────────────────────
	recentCommitWarning: "Recent commit warning:",
	recentCommitMessage: "This skill was updated {{days}} day{{s}} ago. Treat recent updates as high risk and review diffs before trusting/enabling.",
	...
	securityIntro: "Skills are community-authored instructions that the AI agent follows <strong>with your full system privileges</strong>. Popularity or download count does not mean a skill is safe. A malicious skill can instruct the agent to:",
	threat1: "Execute arbitrary shell commands on your machine (install malware, cryptominers, backdoors)",
	threat2: "Read and exfiltrate sensitive data \u2014 SSH keys, API tokens, browser cookies, credentials, env variables",
	...
	securityReview: "Triple-check the source code of every skill before enabling it. Read the full SKILL.md and any scripts it references \u2014 these are the exact instructions the agent will execute on your behalf. Do not trust a skill just because it is popular, highly downloaded, or appears on a leaderboard.",
