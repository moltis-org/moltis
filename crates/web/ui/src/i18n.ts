...
const namespaces: Record<string, (lng: string) => Promise<{ default?: Record<string, unknown> }>> = {
	common: (lng: string) => import(`./locales/${lng}/common.js`),
	errors: (lng: string) => import(`./locales/${lng}/errors.js`),
	settings: (lng: string) => import(`./locales/${lng}/settings.js`),
	providers: (lng: string) => import(`./locales/${lng}/providers.js`),
	chat: (lng: string) => import(`./locales/${lng}/chat.js`),
	onboarding: (lng: string) => import(`./locales/${lng}/onboarding.js`),
	login: (lng: string) => import(`./locales/${lng}/login.js`),
	crons: (lng: string) => import(`./locales/${lng}/crons.js`),
	mcp: (lng: string) => import(`./locales/${lng}/mcp.js`),
	skills: (lng: string) => import(`./locales/${lng}/skills.js`),
	channels: (lng: string) => import(`./locales/${lng}/channels.js`),
	hooks: (lng: string) => import(`./locales/${lng}/hooks.js`),
	projects: (lng: string) => import(`./locales/${lng}/projects.js`),
	images: (lng: string) => import(`./locales/${lng}/images.js`),
	metrics: (lng: string) => import(`./locales/${lng}/metrics.js`),
	pwa: (lng: string) => import(`./locales/${lng}/pwa.js`),
	sessions: (lng: string) => import(`./locales/${lng}/sessions.js`),
	logs: (lng: string) => import(`./locales/${lng}/logs.js`),
};
	...
	initPromise = i18next
		...
		.then(() => {
			...
			if (i18next.language !== locale.value) {
				return i18next.changeLanguage(locale.value) as unknown as void;
			}
		})
		.then(() => {
