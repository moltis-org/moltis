...
export default {
	...
	memory: {
		...
		zvecSearchType: "HNSW + FTS（原生）",
		qmdSearchType: "BM25 + 向量 + LLM",
		externalDependency: "外部相依",
		noDependency: "無",
		cppZvecLibrary: "C++ zvec 程式庫",
		nodejsBun: "Node.js/Bun",
		embeddingCache: "嵌入快取",
		batchOperations: "批次操作",
		gracefulFallback: "優雅備援",
		fallbackToSqlite: "\u2713（\u2192 SQLite）",
		notApplicable: "不適用",
		reranking: "重新排序",
		rerankingBuiltIn: "\u2713",
		rerankingZvec: "\u2713（RRF + 加權）",
		rerankingQmd: "\u2713（LLM）",
		builtInBestFor: "一般用途",
		zvecBestFor: "向量原生工作負載",
		qmdBestFor: "研究 / 問答",
