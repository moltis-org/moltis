...
const chatPageHTML =
	...
	'<div id="sessionHeaderToolbarMount" class="ml-auto flex items-center gap-1.5"></div></div>' +
	'<div class="chat-badges-bar h-10 px-4 border-b border-[var(--border)] bg-[var(--surface)] flex items-center justify-center gap-2" style="grid-row:2;">' +
