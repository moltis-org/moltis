...
export interface RpcMethodMap {
	...
	"mcp.git.credentials.create": unknown;
	"mcp.git.credentials.list": unknown;
	"mcp.git.credentials.remove": unknown;
	"mcp.git.credentials.update": unknown;
	"mcp.list": unknown;
	"mcp.managed.approve": unknown;
	"mcp.remove": unknown;
	"mcp.repositories.install": unknown;
	"mcp.repositories.list": unknown;
	"mcp.repositories.preview": unknown;
	"mcp.repositories.remove": unknown;
	"mcp.repositories.rollback": unknown;
	"mcp.repositories.update.apply": unknown;
	"mcp.repositories.update.preview": unknown;
	"mcp.restart": unknown;
	"mcp.tools": unknown;
	"mcp.update": unknown;
