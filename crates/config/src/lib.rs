...
pub use {
    ...
    schema::{
        ...
        CompactionConfig, CompactionMode, ContentCaptureMode, DatadogSettings, GeoLocation,
        GroupToolPolicy, HeartbeatConfig, HomeAssistantAccountConfig, HomeAssistantConfig,
        InstrumentationConfig, LangfuseSettings, MemoryBackend, MemoryCitationsMode,
        MemoryProvider, MemoryScope, MemorySearchMergeStrategy, MemoryStyle, MessageQueueMode,
        ModePreset, ModesConfig, MoltisConfig, NgrokConfig, OtlpSettings, PresetMemoryConfig,
