...
pub(super) fn build_schema_map() -> KnownKeys {
    ...
    let sandbox = || {
        Struct(HashMap::from([
            ...
            ("vercel_token", Leaf),
            ("vercel_project_id", Leaf),
            ("vercel_team_id", Leaf),
            ("vercel_runtime", Leaf),
            ("vercel_timeout_ms", Leaf),
            ("vercel_vcpus", Leaf),
            ("vercel_snapshot_id", Leaf),
            ("daytona_api_key", Leaf),
            ("daytona_api_url", Leaf),
            ("daytona_target", Leaf),
            ("daytona_image", Leaf),
            ("coder_url", Leaf),
            ("coder_token", Leaf),
            ("coder_organization", Leaf),
            ("coder_user", Leaf),
            ("coder_template_id", Leaf),
            ("coder_template_name", Leaf),
            ("coder_workspace_prefix", Leaf),
            ("coder_ttl_ms", Leaf),
            ("coder_size", Leaf),
            ("coder_template_presets", Map(Box::new(Leaf))),
            ("coder_parameter_values", Map(Box::new(Leaf))),
            ("firecracker_bin", Leaf),
            ("firecracker_kernel", Leaf),
            ("firecracker_rootfs", Leaf),
            ("firecracker_ssh_key", Leaf),
            ("firecracker_vcpus", Leaf),
            ("firecracker_memory_mb", Leaf),
        ]))
    };
