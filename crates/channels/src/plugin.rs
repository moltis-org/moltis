...
///
/// The chat layer emits these; the gateway forwards them to a per-session
/// reaction controller. Kept intentionally small — richer phases are derived
/// from the tool name at the controller.
#[derive(Debug, Clone)]
