...
- GraphQL API at `/graphql` (GET serves GraphiQL playground, POST handles queries/mutations, WebSocket at `/graphql/ws` handles subscriptions) exposing all RPC methods as typed operations
